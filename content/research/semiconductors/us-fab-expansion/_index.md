---
title: "US Domestic Fab Expansion"
date: 2026-04-24
lastmod: 2026-04-24
draft: false
...
source_urls:
  ...
  - "https://newsroom.intel.com/press-kit/us-chips-act-funding-intel"
...
**Key Tracking Parameters:** For each project, document: facility operator/owner, geographic location (state, city, county), target process node tier, planned capacity (wafers per month — wpm), total capital investment, CHIPS Act funding status (preliminary memorandum of terms vs. binding award vs. disbursement), construction timeline, and current status. The PMT is a preliminary term only, not a binding commitment.

**Strategic Flags:** 
- ⚑ Flag any fab that is the sole planned US source for a specific process node tier
- ⚑ Document CHIPS Act award progression: PMT → Binding Award → Disbursement
- ⚑ Flag any major timeline slips or construction delays reported in the past 90 days

**Key People:** For each major fab project, document the lead executive responsible and include career background, prior roles, and any board/investor connections. Cross-reference executives across companies.

**Export Control Relevance:** Some fab projects (Intel, TSMC) trigger interagency export control reviews. Document any relevant restrictions or licensing requirements.

**Review Cadence:** 90 days. Fab timelines slip frequently; funding status changes; construction delays are common. This section requires quarterly updates.
...
- [Semiconductor Industry Association - CHIPS Supply Chain Investments](https://www.semiconductors.org/chip-supply-chain-investments/)
- [Manufacturing Dive - CHIPS Act Tracker](https://www.manufacturingdive.com/news/chips-and-science-act-tracker-semiconductor-manufacturing/734039/)
- [Intel Newsroom - CHIPS Act Funding](https://newsroom.intel.com/press-kit/us-chips-act-funding-intel)
- [Department of Commerce NIST - CHIPS Program Office](https://www.nist.gov/chips/)
