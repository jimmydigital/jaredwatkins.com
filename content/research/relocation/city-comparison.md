...
```mermaid
radar-beta
  title Deep South & Gulf Coast
  axis safety["Safety"], diversity["Diversity"], afford["Affordability"], tech["Tech"]
  curve cha["Chattanooga TN"]{3, 5, 7, 4}
  curve hsv["Huntsville AL"]{8, 5, 9, 5}
  curve mob["Mobile AL"]{4, 7, 9, 2}
  curve bna["Nashville TN"]{5, 5, 6, 7}
  curve msy["New Orleans LA"]{1, 8, 8, 2}
  max 10
  min 0
  showLegend true
  graticule polygon
...
```mermaid
radar-beta
  title Texas & Southwest
  axis safety["Safety"], diversity["Diversity"], afford["Affordability"], tech["Tech"]
  curve abq["Albuquerque NM"]{1, 7, 7, 3}
  curve aus["Austin TX"]{8, 5, 7, 9}
  curve elp["El Paso TX"]{9, 9, 9, 2}
  curve sat["San Antonio TX"]{3, 9, 8, 5}
  max 10
  min 0
  showLegend true
  graticule polygon
...
```mermaid
radar-beta
  title Mountain West, Pacific & Mid-Atlantic
  axis safety["Safety"], diversity["Diversity"], afford["Affordability"], tech["Tech"]
  curve den["Denver CO"]{5, 5, 5, 6}
  curve gsp["Greenville-Spart SC"]{6, 4, 7, 5}
  curve iad["Herndon VA"]{10, 6, 7, 9}
  curve mia["Miami FL"]{4, 10, 3, 6}
  curve sea["Seattle WA"]{4, 5, 4, 10}
  curve tpa["Tampa FL"]{5, 7, 7, 6}
  max 10
  min 0
  showLegend true
  graticule polygon
...
radar-beta
  ...
  curve den["Denver CO"]{5, 5, 5, 6}
  curve aus["Austin TX"]{8, 5, 7, 9}
  curve gsp["Greenville SC"]{6, 4, 7, 5}
  curve clt["Charlotte NC"]{4, 7, 7, 7}
  curve cmh["Columbus OH"]{5, 6, 10, 6}
  curve bna["Nashville TN"]{5, 5, 6, 7}
  max 10
