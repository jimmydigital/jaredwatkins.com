---
title: "Kairos Power — Molten-Salt SMR for Data Centers"
date: 2026-04-21
lastmod: 2026-04-24
draft: false
...
source_urls:
  ...
  - "https://www.datacenterdynamics.com/en/news/smr-firm-kairos-power-completes-reactor-vessel-installation-for-new-test-unit/"
  - "https://www.globenewswire.com/news-release/2026/04/17/3276457/0/en/kairos-power-breaks-ground-on-hermes-2-demonstration-plant.html"
  - "https://www.world-nuclear-news.org/articles/kairos-breaks-ground-for-hermes-2-reactor"
  - "https://interestingengineering.com/energy/us-kairos-breaks-ground-hermes-nuclear-reactor"
...
**Sources:**
- [Kairos Power Breaks Ground on Hermes 2 Demonstration Plant (GlobeNewswire, April 17, 2026)](https://www.globenewswire.com/news-release/2026/04/17/3276457/0/en/kairos-power-breaks-ground-on-hermes-2-demonstration-plant.html)
- [World Nuclear News: Kairos breaks ground for Hermes 2 reactor](https://www.world-nuclear-news.org/articles/kairos-breaks-ground-for-hermes-2-reactor)
- [Interesting Engineering: First 4th-gen US nuclear reactor breaks ground to power Google data centers](https://interestingengineering.com/energy/us-kairos-breaks-ground-hermes-nuclear-reactor)
...
1. **Hydrogen production:** Electrolysis (powered by reactor electricity) + high-temp steam (from reactor exhaust) enables efficient hydrogen synthesis. Hydrogen is critical for green synthetic fuels, ammonia production, and future energy storage.
2. **Desalination:** High-temp water enables reverse osmosis or multi-effect distillation. Critical for water-scarce data center regions (Arizona, California).
3. **District heating/cooling:** Excess thermal energy can serve adjacent industrial parks, reducing total site energy consumption.
...
**Location:** DOME (Demonstration of Microreactor Experiments) facility, INL
**Capacity:** ~10 MW thermal (small demonstration)
**Schedule:**
...
**Location:** Oak Ridge, Tennessee (Kershaw site, near existing ORR nuclear facilities)
**Partner:** Tennessee Valley Authority (TVA)
...
- **Chris Levesque** (CEO) — Ph.D. nuclear engineering (MIT); [LinkedIn](https://www.linkedin.com/in/chris-levesque-kairos/): not confirmed — TODO: verify slug. Prior: SVP at TerraPower (overlapping with leadership period of other documented company; see [TerraPower BTM entry]({{< relref "terrapower-btm.md" >}})); NRC and DOE engagement experience. **⚑ Overlap:** Levesque came directly from TerraPower — the two companies share sodium-cooled SMR development heritage and compete in data center nuclear space.
...
1. ✅ **Hermes 2 groundbreaking (April 17, 2026):** COMPLETED — construction has begun; first NRC-permitted Gen IV reactor in U.S.
2. **Hermes 1 nuclear construction progress (INL):** Reactor vessel installation completed; startup sequence proceeding toward 2027 target
3. **Hermes 2 operating license application submission:** Kairos preparing to submit as of February 2026; submission expected mid-2026; NRC review 18–24 months
4. **BWXT capacity planning:** Public announcement of TRISO capacity expansion plans (critical for signaling TRISO supply resolved for Hermes 3–7)
5. **Kairos financing rounds:** Series D/E funding round announced (signals confidence in Hermes 2 timeline, now anchored by construction permit and groundbreaking)
6. **First power delivery to TVA (target ~2030):** Grid-connected power starts flowing to Google data centers in Tennessee and Alabama

---

## Risks & Uncertainties

1. **Molten-salt operational complexity:** Molten salt is a proven heat transfer medium (CSP plants, industrial), but **reactor-grade** molten salt (with neutron activation, tritium handling, corrosion management) is unproven at commercial scale. Hermes 1 is the critical test; failures there could delay Hermes 2.

2. **TRISO supply tightness:** BWXT must expand capacity on schedule; if delays occur, Hermes 3–7 deployments slow.

3. **Google's PPA pricing terms:** Google negotiated pricing + thermal energy terms not disclosed. If disclosed later, competitors (Amazon, Microsoft, Meta) may balk at similar PPA economics.

4. **TVA regulatory integration:** TVA has unique federal authority, but political shifts or safety concerns could slow approval; TVA stakeholder backlash is a non-technical risk.
