...
**Key topics:**
- **Solar Turbines portfolio:** Industrial gas turbines (1–39 MW class); proven in oil & gas, power generation, CHP
- **Data center pivot:** Marketing efforts targeting data center BTM market (2024–2026)
- **Vertiv partnership (Nov 2025):** Integration of power generation, cooling, electrical infrastructure for modular data center power plants
- **Competitive position:** Mid-sized turbines (1–39 MW); not dominant in aeroderivative space (GE Vernova) or small engines (Wärtsilä, Capstone); positioned for medium-scale BTM facilities
- **Market traction:** Limited binding orders for data center BTM as of April 2026 (vs. GE Vernova 2.4B Q1 2026 orders, Wärtsilä 2.4+ GW cumulative)
- **Manufacturing:** Global footprint; proven supply chain (oil & gas demand validation)

**Track:**
- Vertiv partnership execution and integrated product-market fit
- Data center design wins and signed contracts
- Supply chain lead times and capacity constraints
...
**Partners:** Caterpillar/Solar Turbines + Vertiv Global Solutions
**Announcement date:** November 2025
**Focus:** Turnkey modular data center power plant
...
- [LinkedIn](https://www.linkedin.com/in/jim-umpleby/): TODO: verify slug.
...
- {{< relref "ge-vernova-aeroderivative.md" >}} — GE Vernova (dominant aeroderivative supplier, $2.4B Q1 2026 data center orders)
- {{< relref "wartsila-btm.md" >}} — Wärtsilä (reciprocating engine leader, 2.4+ GW cumulative data center orders)
- {{< relref "siemens-energy-btm.md" >}} — Siemens Energy (heavy-frame turbines, modular 500 MW plants)
