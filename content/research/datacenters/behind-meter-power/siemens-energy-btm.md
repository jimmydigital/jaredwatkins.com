...
**Key topics:**
- **Product portfolio:** SGT-600, SGT-700, SGT-750, SGT-800 series (40–200+ MW); heavy-frame turbines for baseload and flexible operation
- **Modular power plant concept:** Standardized 500 MW integrated plant with gas turbines + generators + cooling + electrical distribution
- **Data center market growth:** Turnaround in 2024–2025 (nearly doubled turbine sales from 100 units 2024 to 194 units 2025)
- **Eaton partnership (2025):** Integration of Siemens turbines with Eaton power distribution and cooling systems for turnkey data center power plants
- **Supply chain:** Dual manufacturing (Siemens Germany, licensed production in Japan with Mitsubishi)
- **Hydrogen roadmap:** H-Class turbines planned for 2030s; hybrid gas/hydrogen operation by late 2020s
- **Competitive position:** Large modular plants (40–200+ MW); not competing directly with Wärtsilä/Capstone in small engines or GE Vernova in mid-range aeroderivatives

**Track:**
- Eaton partnership execution and integrated product launch
- Turbine sales ramp and data center customer wins
- Modular plant deployment (first commercial 500 MW plant for data center)
...
| Attribute | Value |
|-----------|-------|
| **Company** | Siemens Energy AG (München, Germany) |
| **Primary Market** | Utilities, oil & gas, power generation, industrial |
| **Data Center Entry** | 2024–2025 (formal market focus) |
| **Key Product** | SGT (Siemens Gas Turbine) series, 40–200+ MW |
| **Modular Strategy** | Standardized 500 MW power plant modules |
| **Key Partnership** | Eaton (power distribution, cooling integration) — announced 2025 |
| **CEO** | Christian Bruch — raised mid-term guidance on data center turbine demand (2025) |
| **2025 Performance** | Turbine orders nearly doubled (194 units 2025 vs. 100 in 2024) |
...
| Model | Power Range | Technology | Status | Data Center Use |
|---|---|---|---|---|
| **SGT-600** | 40–50 MW | Mature design (1990s heritage) | In production | Legacy plants; less attractive for new BTM |
| **SGT-700** | 45–60 MW | Advanced (2010s) | In production | Mid-range modular plants |
| **SGT-750** | 55–65 MW | Efficiency-optimized | In production | Flexible operation, good part-load |
| **SGT-800** | 60–75 MW | Latest (2020s design) | In production | Best efficiency; preferred for new data center plants |
| **Heavy-frame variants** | 100–200+ MW | Custom configurations | Custom order | Large multi-turbine plants (less typical for colocation) |
...
**Partners:** Siemens Energy + Eaton Global Solutions
**Announcement:** November 2025
**Focus:** Integrated modular data center power plants (500 MW standard configuration)

**Solution components:**

| Component | Provider | Function |
|-----------|----------|----------|
| **Power generation** | Siemens Energy | SGT-800 turbine(s) (60–75 MW each) |
| **Power distribution** | Eaton | Medium-voltage switchgear, UPS, backup power integration |
| **Cooling integration** | Eaton | Liquid cooling loops, cooling plant, integration with data center HVAC |
| **Containerization & modularity** | Eaton | Modular enclosure, transportation infrastructure |
| **Automation & controls** | Eaton/Siemens | SCADA, remote operations, grid interconnection controls |
| **Service & support** | Joint | Shared responsibility, regional service centers |
...
| Aspect | Siemens/Eaton 500 MW Modular | GE Vernova Aeroderivative | Wärtsilä Reciprocating Engine |
|--------|---|---|---|
| **Unit size** | 60–75 MW (7-turbine module) | 20–30 MW (single turbine) | 5–50 MW per engine |
| **Scalability approach** | Modular 500 MW plants | Cluster multiple turbines | Scale via engine count |
| **Cooling integration** | Eaton designed-in | Add-on (customer integration) | Add-on (customer integration) |
| **Part-load efficiency** | 35–39% across range | 40%+ full load, drops below 30% at 25% | Excellent at 75–85% load |
| **Start-up time** | 30+ minutes | 5–10 minutes | 5–15 minutes |
| **Target segment** | Large modular plants (100–500+ MW) | Mid-range clusters (50–300 MW) | Small-to-mid clusters (10–150 MW) |
...
|-----------|-------|----------|
| **Turbine + compressor + combustor** | 30% | $1.2–1.8M per MW |
| **Generator** | 15% | $600K–900K per MW |
| **Auxiliary systems (fuel, cooling, exhaust)** | 15% | $600K–900K per MW |
| **Controls & instrumentation** | 10% | $400K–600K per MW |
| **Installation, integration, contingency** | 30% | $1.2–1.8M per MW |
| **Total capex (all-in)** | 100% | **$4.0–6.0M per MW** |
...
|------|-----------|-------------|--------|
| 2026 | First named data center customer (Eaton-integrated 500 MW module) | Medium | Validates product-market fit |
| 2026–2027 | Eaton modular plant design freeze and manufacturing prep | Medium | De-risks first deployment |
| 2027 | Turbine 1 critical and power generation (first Eaton module) | Low–Medium | Demonstrates delivery capability |
| 2027–2028 | Second customer order (cumulative 500–1,000 MW pipeline) | Low | Market acceptance signal |
| 2028+ | H-Class hydrogen turbine prototype testing | Medium | Future-proofs product line |
| 2029–2030 | Market share in large modular plant segment (100–500 MW) | Low | Competitive position clarity |
...
- [LinkedIn](https://www.linkedin.com/in/christian-bruch-siemens-energy/): TODO: verify slug
...
- {{< relref "ge-vernova-aeroderivative.md" >}} — GE Vernova (dominant aeroderivative supplier)
- {{< relref "wartsila-btm.md" >}} — Wärtsilä (reciprocating engine leader, 2.4+ GW cumulative orders)
- {{< relref "caterpillar-solar-turbines.md" >}} — Solar Turbines / Caterpillar (mid-sized turbines + Vertiv partnership)
- {{< relref "../power-infrastructure/_index.md" >}} — Power infrastructure overview (turbine categories, technology trends)
