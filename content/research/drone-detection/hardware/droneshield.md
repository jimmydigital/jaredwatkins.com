...
- **Ticker:** [DRO](https://finance.yahoo.com/quote/DRO) (ASX)
- **HQ:** Sydney, Australia
- **Founded:** 2014
...
**DroneSentry (fixed-site C-UAS):**
A modular fixed installation combining:
...
**Supporting sources:** [MSS Defence product listing](https://mssdefence.com/product/droneshield-dronesentry/) states 1 km range at 30° per dish sensor.
**Qualifying notes:** 1 km is likely best-case in low-ambient-noise conditions. Urban/industrial environments near HVAC, traffic, or generators would significantly reduce this.
**Summary:** 1 km stated; realistic range in noisy environments likely 100–300 m.

## Sources

- [DroneShield corporate site](https://www.droneshield.com/)
