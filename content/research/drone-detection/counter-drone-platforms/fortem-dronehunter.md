...
1. TrueView radar detects and tracks a threat drone at up to 4+ km range using micro-Doppler classification
2. SkyDome Manager software assesses threat and cues DroneHunter launch
3. DroneHunter launches within seconds
4. Onboard AI and dual cameras acquire and track the target autonomously
5. DroneHunter intercepts target and deploys a capture net
6. Net entangles the target drone's rotors, rendering it inoperative
7. DroneHunter returns to launch site; can be reloaded in under 3 minutes
...
- [DroneHunter F700 product page](https://fortemtech.com/products/dronehunter-f700/)
- [F700 datasheet (PDF)](https://cdn.prod.website-files.com/648c3eaae99a3460f13becec/64a7deadd6b09be15aded1c7_MKT_DH%20F700-Data%20Sheet_20230119.pdf)
- [Ukraine procurement — Defence Express](https://en.defence-ua.com/weapon_and_tech/ukrainians_buy_dronehunter_a_predator_uav_to_catch_shahed_136_zala_and_orlan_10-8620.html)
