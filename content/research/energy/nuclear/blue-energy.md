...
**⚑ Direct datacenter overlap:** Blue Energy is the power supplier for Crusoe's Port of Victoria AI datacenter campus. See [`datacenters/design-construction/crusoe.md`]({{< relref "../../datacenters/design-construction/crusoe.md" >}}) and [`datacenters/power-infrastructure/_index.md`]({{< relref "../../datacenters/power-infrastructure/_index.md" >}}).
