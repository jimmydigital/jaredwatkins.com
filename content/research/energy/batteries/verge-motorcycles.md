...
- **2026-01 (CES):** TS Pro announced with 370-mile range and solid-state battery; immediate industry skepticism alongside genuine technical interest. ([IEEE Spectrum](https://spectrum.ieee.org/ces-2026-solid-state-batteries))
...
- **⚑ Overlap (corporate family):** Same individual controls [Donut Lab]({{< relref "donut-lab.md" >}}) and Verge Motorcycles. Notably, his previous venture Damon Motors is a direct EV motorcycle competitor to Verge.
...
Verge Motorcycles operates at the **OEM Integration** layer — it is the vehicle integrator and launch customer for Donut Lab's solid-state cells. Verge does not manufacture batteries; [Donut Lab]({{< relref "donut-lab.md" >}}) / Nordic Nano supply the cells, which Verge integrates into motorcycle packs. Upstream: Verge's battery supply is 100% from the Donut Lab / Nordic Nano corporate family. Downstream: Verge sells directly to consumers (TS Pro, from $29,900). There are no disclosed third-party battery supplier relationships; Verge's supply chain is entirely captive to its affiliated battery company. This creates concentration risk at the supply level — any manufacturing or validation problem at Donut Lab / Nordic Nano directly halts Verge's ability to deliver vehicles.

## Sources

- [Verge unveils 370-mile electric motorcycle with solid-state battery — Electrek (Jan 2026)](https://electrek.co/2026/01/05/verge-unveils-370-mile-electric-motorcycle-with-solid-state-battery/)
- [Verge Motorcycles makes history — first motorcycles with solid-state batteries — Verge Motorcycles](https://www.vergemotorcycles.com/gl_en/solid-state-battery-announcement/)
- [Solid State Batteries Redefine Electric Motorcycles — IEEE Spectrum (CES 2026)](https://spectrum.ieee.org/ces-2026-solid-state-batteries)
- [Donut Lab shows solid-state battery pack charging at 100 kW in Verge motorcycle — Electrek (Mar 2026)](https://electrek.co/2026/03/16/donut-lab-solid-state-battery-pack-test-verge-motorcycles/)
