...
3. **Cost-benefit geography:** CPV efficiency leadership is offset by:
   ...
   - Geographic specificity (DNI-dependent)
   This demonstrates that efficiency alone does not dictate market dominance; cost, deployment flexibility, and supply chain maturity matter equally.
...
- [Caelux — caelux.com](https://www.caelux.com/)
- [Concentrated Photovoltaics (CPV) Technology Review — NREL](https://www.nrel.gov/)
- [Multijunction Solar Cell Efficiency Records — NREL Chart](https://www.nrel.gov/pv/)
- [CPV Market Analysis — Bloomberg NEF](https://www.bloomberg.com/energy)
- [Direct Normal Irradiance (DNI) Maps — World Bank / NASA](https://solargis.com/)
