...
| Layer | Detail |
|-------|--------|
| **Silicon wafers** | Standard crystalline silicon wafers (monocrystalline, p-type, ~156 mm sq.); sourced from established suppliers (Wacker, Longi, JA Solar, etc.) |
| **Perovskite precursors** | Halide perovskite chemicals (lead iodide, cesium iodide, formamidinium iodide, etc.); specialized organic/inorganic suppliers (GreatCell, Lumtec, or custom synthesis) |
| **Encapsulation materials** | Transparent polymers (EVA, PVB) or specialized edge sealing; standard module materials |
| **Module assembly** | Leverages existing silicon module assembly lines (glass, frame, junction box, curing); minimal new capital equipment |
| **End market** | Utility-scale solar farms, commercial rooftop, residential rooftop; distributed through established PV module channels |
...
- [Tandem PV — tandem-pv.com](https://www.tandem-pv.com/)
- [Perovskite-Silicon Tandem Solar Cells — NREL Research](https://www.nrel.gov/)
- [Fraunhofer ISE Perovskite Tandem Efficiency Records](https://www.ise.fraunhofer.de/)
- [Photovoltaic Research Handbook — IEEE Spectrum](https://spectrum.ieee.org/)
