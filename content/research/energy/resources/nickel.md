...
| [Vale](https://www.vale.com) (NYSE: VALE) | Brazil | Mining (Canada, Indonesia, Brazil) | Major Class I nickel producer; Sudbury and Voisey's Bay mines (Canada) |
| [Norilsk Nickel / Nornickel](https://www.nornickel.com) | Russia | Mining + refining | Major sulfide nickel producer; ~7% of global supply; sanctions risk for Western buyers |
| [BHP](https://www.bhp.com) (ASX: BHP) | Australia | Mining | Nickel West (WA); Class I nickel; BHP considering exit from nickel as of 2025 due to Indonesian competition |
| [Glencore](https://www.glencore.com) | Switzerland | Trading + mining | Significant nickel position globally |
...
- **[Lyten]({{< relref "../batteries/lyten.md" >}})** (Li-S chemistry): Zero nickel — sulfur cathode and lithium metal anode use no transition metals.
- **[Factorial Energy]({{< relref "../batteries/factorial-energy.md" >}})**: FEST® cells can use NMC cathodes (including high-nickel NMC811 or NMC90+), but the partnership with POSCO Future M is exploring Ultra Hi-Ni single-crystal cathodes that maximize energy per gram of nickel rather than requiring more nickel by volume. Overall nickel content per kWh is lower than NMC622 or NMC811 designs in some solid-state configurations.
- **[Adden Energy]({{< relref "../batteries/adden-energy.md" >}})**, **[QuantumScape]({{< relref "../batteries/quantumscape.md" >}})**, **[Solid Power]({{< relref "../batteries/solid-power.md" >}})**, **[ProLogium]({{< relref "../batteries/prologium.md" >}})**: All use lithium metal anodes, which allow flexibility in cathode chemistry; the cathode specifics for commercial-scale cells are not fully disclosed but can be adapted to cobalt-free, lower-nickel formulations.
- **[Idemitsu Kosan]({{< relref "../batteries/idemitsu-solid-state.md" >}})**: Supplies electrolyte; cathode nickel content is Toyota's design choice.
- **[Donut Lab]({{< relref "../batteries/donut-lab.md" >}})**: TiO₂-based design; no nickel in the cathode.
...
- [Indonesia Nickel Market Dominance — Discovery Alert](https://discoveryalert.com.au/indonesian-nickel-dominance-global-market-2025/)
- [Nickel still capped by surplus — ING Think](https://think.ing.com/articles/nickel-still-capped-by-surplus/)
- [Beyond NMC batteries: Supply chain issues for emerging battery technologies — IEA Global Critical Minerals Outlook 2025](https://www.iea.org/reports/global-critical-minerals-outlook-2025/beyond-nmc-batteries-supply-chain-issues-for-emerging-battery-technologies)
- [Nickel king Indonesia relies on China's CATL for EV supply chain ambitions — KR Asia](https://kr-asia.com/nickel-king-indonesia-relies-on-chinas-catl-for-ev-supply-chain-ambitions)
