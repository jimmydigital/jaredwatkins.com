...
source_urls:
  ...
  - "https://www.electrive.com/2025/03/01/idemitsu-kosan-builds-plant-for-lithium-sulphide/"
...
[Idemitsu Kosan]({{< relref "../batteries/idemitsu-solid-state.md" >}}) is an oil major that has spent 30+ years developing sulfide solid electrolyte technology. Its petroleum refining operations produce sulfur as a byproduct, and its Battery Material Development Center converts that sulfur into Li₂S and ultimately into solid electrolyte material. This integrated value chain — from crude oil refining through sulfur production to electrolyte manufacturing — is a unique competitive moat.
...
|---------|---------------|-------|
| [Lyten]({{< relref "../batteries/lyten.md" >}}) | Li-S cathode (elemental sulfur) | Commodity-grade; no strategic supply risk |
| [Solid Power]({{< relref "../batteries/solid-power.md" >}}) | Sulfide solid electrolyte (Li₂S precursor) | Requires battery-grade Li₂S from suppliers like Idemitsu |
| [QuantumScape]({{< relref "../batteries/quantumscape.md" >}}) | Sulfide-based ceramic separator (Li₂S precursor) | Similar Li₂S dependency |
| [Idemitsu Kosan]({{< relref "../batteries/idemitsu-solid-state.md" >}}) | Li₂S production + solid electrolyte manufacturing | Only vertically integrated Li₂S + SE producer documented here |
| [ProLogium]({{< relref "../batteries/prologium.md" >}}) | Oxide-based electrolyte (ceramic, not sulfide) | Does NOT use sulfide-route electrolyte; no sulfur dependency |
...
- [Idemitsu Kosan builds plant for lithium sulphide — Electrive (Mar 2025)](https://www.electrive.com/2025/03/01/idemitsu-kosan-builds-plant-for-lithium-sulphide/)
...
- [A look at Team Idemitsu's development and mass production of solid electrolytes — Idemitsu (Mar 2025)](https://www.idemitsu.com/en/2050future/action/250325.html)
