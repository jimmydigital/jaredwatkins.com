...
## Datacenter Opposition Section — Steering Instructions

This section tracks opposition to datacenter construction and operation across the United States. The focus is on coordinated and grassroots campaigns, legal and legislative strategies, organizing groups, and funding networks that power datacenter resistance. This is a fast-moving area with significant political momentum as of April 2026.

---

### Scope

**In scope:** Opposition campaigns targeting datacenter sites, including zoning and land-use challenges, environmental review and litigation, utility rate disputes, state and local legislative efforts (moratoriums, tax incentive repeal, grid reliability mandates), community organizing, ballot initiatives, and national advocacy networks. Projects blocked, delayed, or stalled due to opposition. Funding sources and network connections between opposition organizations.

**Out of scope:** Datacenter industry technical details, vendor profiles, or project development independent of opposition dynamics. (See `research/datacenters/` for industry coverage.)

---

### Editorial Priority

1. **Project tracker comprehensiveness.** Maintain a database of 20+ notable contested projects across multiple states, including project name, developer/owner, location, scale, status, primary opposition tactics, and current status. Update quarterly as new projects surface or existing ones resolve.

2. **Funding opacity and network mapping.** Identify shared funders, board members, and messaging between opposition groups. Search IRS 990 forms (ProPublica Nonprofit Explorer), state charity filings, and public disclosures. Flag cases where utility companies or incumbent energy interests fund opposition; also note funding from environmental foundations and think tanks.

3. **Tactical evolution.** Document how opposition tactics shift by region and over time. Track which approaches succeed (litigation, zoning reform, legislative moratoriums) and which do not. Note geographic spread of moratorium bills across states.

4. **Claim verification.** When opposition groups claim environmental impact (water consumption, noise, grid strain, property values), cite the specific studies or data sources backing the claim. When claims are disputed, document the dispute and note verification status.

5. **Organizing group profiles.** For the 3–5 most significant national/multi-state opposition groups, write 300–500 word profiles covering mission, funding, key campaigns, and linkages to other groups.

---

### Key Themes (as of April 2026)
...
- **Litigation is a major tactic.** Zoning challenges, environmental review under NEPA equivalents, air and water permit appeals, trade secret disputes over facility specifications. Virginia courts blocked the massive PW Digital Gateway project twice.

- **National environmental coalition forming.** 230+ organizations signed a Food & Water Watch-led letter calling for a federal moratorium. Sierra Club, NRDC, SELC, and others file repeated lawsuits at state and local levels.
...
When documenting opposition claims:

1. **Water consumption:** Cite facility-specific gallons-per-day or percent-of-municipal-supply figures if available. Note whether water is recycled or once-through cooling.

2. **Grid reliability:** Reference ERCOT studies, state utility commission filings, ISO/RTO interconnection queues. Distinguish between load growth projections and actual grid stress.

3. **Job claims:** Opposition often challenges datacenter job creation claims. Note whether "jobs" counts temporary construction vs. permanent operations, and whether permanent jobs go to locals or imported specialists.

4. **Property values:** Some opposition groups claim property value impacts; few peer-reviewed studies exist. Flag claims without evidence as "disputed" or "unverified."

5. **Noise and air quality:** Reference local ordinance limits, decibel measurements, air permit data (NAIRU, etc.), and environmental justice research.

---

### Research Phases

- **Phase 1 (Current):** Project tracker (15+ projects across 6+ states), state breakdowns (VA, IA, OH, TX, plus 1–2 others), organizing groups (national and regional), funding networks.
- **Phase 2 (Planned):** Legislative tracker (moratorium bills by state, status, text); Tactical analysis (which opposition strategies win; which fail; regional variation).
- **Phase 3 (Planned):** Incumbent energy and utility industry response; Wall Street financing impact (Morgan Stanley de-risking datacenter loans); International precedents (EU, APAC).

---

### Tags

**Opposition tactic:** `zoning-challenge`, `environmental-litigation`, `rate-dispute`, `legislative-moratorium`, `community-organizing`, `ballot-initiative`, `permit-appeal`
...
**Group type:** `national-advocacy`, `local-nimby`, `environmental`, `utility-watchdog`, `labor`, `preservation`, `indigenous-rights`

**Status:** `blocked`, `delayed`, `pending-decision`, `under-construction-despite-opposition`, `completed`

---

### Review Cadence

- **90 days** — Main index and project tracker (opposition dynamics move fast; new projects surface regularly)
- **90 days** — State breakdown files (zoning/legislative changes are frequent)
- **180 days** — Organizing group profiles (coalitions form and shift)
...
- [Data Center Watch Report Q2 2025 - Data Center Watch](https://www.datacenterwatch.org/report)
- [Data centers are expensive, unpopular — and could be a tipping point in the midterms - NPR](https://www.npr.org/2026/04/20/g-s1-117729/data-center-disputes-local-midterms)
- [Local Opposition to Data Centers Is Surging. So Are Canceled Projects - Heatmap News](https://heatmap.news/politics/data-center-cancellations-2025)
- [Data Center Moratorium Bills Are Spreading in 2026 - Good Jobs First](https://goodjobsfirst.org/data-center-moratorium-bills-are-spreading-in-2026/)
...
- [Maine Legislature passes data center moratorium - Spectrum Local News](https://spectrumlocalnews.com/me/maine/business/2026/04/15/maine-legislature-passes-data-center-moratorium)
- [The Fight Over Data Centers - Sierra Club](https://www.sierraclub.org/sierra/fight-over-data-centers)
- [230+ Groups Call for National Moratorium on New Data Centers - Food & Water Watch](https://www.foodandwaterwatch.org/2025/12/08/230-groups-call-for-national-moratorium-on-new-data-centers/)
- [More than 200 environmental groups demand halt to new US data centers - Water Education Foundation](https://www.watereducation.org/aquafornia-news/more-200-environmental-groups-demand-halt-new-us-data-centers)
- [Prince William County supervisors abandon fight for Manassas data centers - Washington Times](https://www.washingtontimes.com/news/2026/apr/15/prince-william-county-supervisors-abandon-fight-manassas-data-centers/)
- [Judges favor local residents in Digital Gateway case - Inside Nova](https://www.insidenova.com/news/prince_william/update-second-ruling-voids-digital-gateway-data-center-project-in-prince-william/article_846b8581-c99e-4f00-bb67-512c78952773.html)
- [Loudoun County, Virginia, Eliminates By-Right Data Center Development - Holland & Knight](https://www.hklaw.com/en/insights/publications/2025/04/loudoun-county-virginia-eliminates-by-right-data-center-development)
- [Facing Its Third Data Center, an Iowa County Rolls Out Extensive Zoning Rules - Inside Climate News](https://insideclimatenews.org/news/01032026/iowa-county-data-center-ordinance/)
- [Ohio's data center boom is running into political resistance - Signal Ohio](https://signalohio.org/ohio-data-center-boom-faces-political-resistence/)
- [Texas lawmakers held a hearing on data centers - KUT Radio](https://www.kut.org/energy-environment/2026-04-13/texas-data-centers-grid-ercot-legislature)
- [Data center opposition group sues Missouri city and proposed developer - NPR Illinois](https://www.nprillinois.org/illinois/2026-04-20/data-center-opposition-group-sues-missouri-city-and-proposed-developer)
- [MEA Files Lawsuit to Challenge Secrecy Surrounding Energy Demands of Meta's Beaver Dam Data Center - Midwest Environmental Advocates](https://midwestadvocates.org/mea-files-lawsuit-to-challenge-secrecy-surrounding-energy-demands-of-metas-beaver-dam-data-center/)
- [We're suing to protect one of the most important conservation areas in the South from data centers - Southern Environmental Law Center](https://www.selc.org/news/were-suing-to-protect-one-of-the-most-important-conservation-areas-in-the-south-from-data-centers/)
...
- [Opposition to data centers is 'catching a fire' across North Carolina - WUNC News](https://www.wunc.org/environment/2026-04-10/opposition-to-data-centers-is-catching-a-fire-across-north-carolina-spurring-political-challenges)
- [Local revolt over data center points to rising resistance in Colorado Springs - Axios Colorado Springs](https://www.axios.com/local/colorado-springs/2026/04/09/data-center-opposition-colorado-springs)
- [Cloudy Data, Costly Deals: How Poorly States Disclose Data Center Subsidies - Good Jobs First](https://goodjobsfirst.org/cloudy-data-costly-deals-how-poorly-states-disclose-data-center-subsidies/)
